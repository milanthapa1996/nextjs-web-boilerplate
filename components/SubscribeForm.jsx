    ...
    <div>
      <React.Fragment>
        <span
          ...
          className="cursor-pointer inline-flex items-center justify-center px-5 py-3 border border-transparent text-base font-medium rounded-md text-primary-500 bg-indigo-100 hover:bg-indigo-200"
        >
          Subscribe
