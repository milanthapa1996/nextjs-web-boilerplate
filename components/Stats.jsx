  ...
  return (
    <div className="bg-indigo-100">
      <div className="px-4 py-2 mx-auto">
        <section className="mb-4 mt-4 text-gray-800 text-center">
          <div className="grid md:grid-cols-2 lg:grid-cols-4 gap-x-6 lg:gap-x-2 items-center">
            <div className="mb-12 lg:mb-0 relative bg-white p-4 rounded-md shadow-md">
              <svg
                className="w-12 h-12 text-primary-700 mx-auto mb-6"
              ...
              <h5 className="text-lg  text-primary-700 font-bold mb-4">5000+</h5>
            ...
            <div className="mb-12 lg:mb-0 relative bg-white p-4 rounded-md shadow-md">
              ...
              <h5 className="text-lg  text-primary-700 font-bold mb-4">490+</h5>
              <h6 className="font-medium text-gray-500">Design blocks</h6>
              <hr className="absolute right-0 top-0 w-px bg-gray-200 h-full hidden lg:block" />
            </div>

            <div className="mb-12 md:mb-0 relative bg-white p-4 rounded-md shadow-md">
              <svg
                className="w-12 h-12 text-primary-700 mx-auto mb-6"
                xmlns="http://www.w3.org/2000/svg"
                viewBox="0 0 512 512"
              ...
              <h5 className="text-lg  text-primary-700 font-bold mb-4">100+</h5>
            ...
            <div className="relative bg-white p-4 rounded-md shadow-md">
              ...
              <h5 className="text-lg  text-primary-700 font-bold mb-4">28</h5>
